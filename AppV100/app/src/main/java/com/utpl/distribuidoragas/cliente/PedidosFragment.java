                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int x=0; x<json.length();x++){
                                ...
                                String precioPublico = String.format( "%.2f", jsonObject.optDouble("pvp"));
                                producto.setPvp("$ " + precioPublico);
                            ...
                            adaptadorProductos.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    Intent intent = new Intent(getContext(), GenerarPedido.class);
                                    intent.putExtra("idProducto", listaProductos.get(recyclerProductos.getChildAdapterPosition(view)).getId());
                                    intent.putExtra("nombre", listaProductos.get(recyclerProductos.getChildAdapterPosition(view)).getProducto());
                                    intent.putExtra("descripcion", listaProductos.get(recyclerProductos.getChildAdapterPosition(view)).getDescripcion());
                                    intent.putExtra("pvp", listaProductos.get(recyclerProductos.getChildAdapterPosition(view)).getPvp());
                                    intent.putExtra("imagen", listaProductos.get(recyclerProductos.getChildAdapterPosition(view)).getImagen());
