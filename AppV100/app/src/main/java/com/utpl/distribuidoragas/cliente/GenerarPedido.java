                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int x=0; x<json.length();x++){
                                ...
                                //verifica ubicacion repartidor
                                if(jsonObject.getDouble("lat") != 0) {
                                    // location dato para manerjar ubicaciones con lat,log
                                    ...
                                    //calcula la distancia de cliente a repartidor en numeros
                                    resultado = locationA.distanceTo(locationB);
                                    //el for busca la siguiente ubicacion mas corta
